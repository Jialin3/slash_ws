...
#define NODE_MAIN_LOGGER_NAME "laserscan_to_pointcloud_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblaserscan_to_pointcloud.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pointcloud_to_laserscan::LaserScanToPointCloudNode>";
