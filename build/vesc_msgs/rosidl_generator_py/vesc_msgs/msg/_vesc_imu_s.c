...
bool vesc_msgs__msg__vesc_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vesc_msgs.msg._vesc_imu.VescImu", full_classname_dest, 31) == 0);
  }
  vesc_msgs__msg__VescImu * ros_message = _ros_message;
  {  // ypr
  ...
  {  // compass
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->compass)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of VescImu */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("vesc_msgs.msg._vesc_imu");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VescImu");
  ...
  {  // compass
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->compass);
    if (!field) {
      return NULL;
    }
    {
