...
bool fast_lio__msg__pose6_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fast_lio.msg._pose6_d.Pose6D", full_classname_dest, 28) == 0);
  }
  fast_lio__msg__Pose6D * ros_message = _ros_message;
  {  // offset_time
...
PyObject * fast_lio__msg__pose6_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fast_lio.msg._pose6_d");
