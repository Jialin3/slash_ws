...
static const _CustomPoint_type_support_symbol_names_t _CustomPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, livox_ros_driver2, msg, CustomPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, livox_ros_driver2, msg, CustomPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, livox_ros_driver2, msg, CustomPoint)() {
  return &::livox_ros_driver2::msg::rosidl_typesupport_c::CustomPoint_message_type_support_handle;
}
