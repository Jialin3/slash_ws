...
static const _VescImu_type_support_symbol_names_t _VescImu_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vesc_msgs, msg, VescImu)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vesc_msgs, msg, VescImu)),
  }
};
...
{
  return &::vesc_msgs::msg::rosidl_typesupport_cpp::VescImu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vesc_msgs, msg, VescImu)() {
  return get_message_type_support_handle<vesc_msgs::msg::VescImu>();
}
