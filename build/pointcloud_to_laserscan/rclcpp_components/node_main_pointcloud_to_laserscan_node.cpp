...
#define NODE_MAIN_LOGGER_NAME "pointcloud_to_laserscan_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpointcloud_to_laserscan.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pointcloud_to_laserscan::PointCloudToLaserScanNode>";
