...
#define NODE_MAIN_LOGGER_NAME "vesc_driver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvesc_driver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<vesc_driver::VescDriver>";
