...
static const _CustomPoint_type_support_symbol_names_t _CustomPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, livox_ros_driver2, msg, CustomPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, livox_ros_driver2, msg, CustomPoint)),
  }
};
...
{
  return &::livox_ros_driver2::msg::rosidl_typesupport_cpp::CustomPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, livox_ros_driver2, msg, CustomPoint)() {
  return get_message_type_support_handle<livox_ros_driver2::msg::CustomPoint>();
}
