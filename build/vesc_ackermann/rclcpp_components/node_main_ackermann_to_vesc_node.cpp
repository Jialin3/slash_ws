...
#define NODE_MAIN_LOGGER_NAME "ackermann_to_vesc_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvesc_ackermann.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<vesc_ackermann::AckermannToVesc>";
