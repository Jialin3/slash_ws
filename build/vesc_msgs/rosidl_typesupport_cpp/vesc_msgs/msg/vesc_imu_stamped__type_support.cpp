...
static const _VescImuStamped_type_support_symbol_names_t _VescImuStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vesc_msgs, msg, VescImuStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vesc_msgs, msg, VescImuStamped)),
  }
};
...
{
  return &::vesc_msgs::msg::rosidl_typesupport_cpp::VescImuStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vesc_msgs, msg, VescImuStamped)() {
  return get_message_type_support_handle<vesc_msgs::msg::VescImuStamped>();
}
